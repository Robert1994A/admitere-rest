...
admitereApp.controller('admissionSessionController', function($scope,
	...
	$scope.containerId = "admission-session-container";
	$scope.admissionSession = {};
	$scope.admissionSessionFound = false;
	$scope.getAdmissionSession = function() {
		...
		var successCallback = function(response) {
			...
			$scope.admissionSession = response.data.content;
			if ($scope.admissionSession) {
				$scope.admissionSessionFound = true;
			}
		...
		comunicationFactory.makeRequest("admission_session/"
				+ $state.params.admissionSessionId, "GET", null,
