...
@Controller
public class RecoverPasswordRestController extends BaseController {

	private static final Logger logger = Logger.getLogger(RecoverPasswordRestController.class);
